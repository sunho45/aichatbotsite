...
user
// Runtime configurn is read from server/.env, with conservative defaults for
...
const statePagePath = path.join(__dirname, "state.html");
const blueprintPagePath = path.join(__dirname, "blueprint.html");
const serverGrammarPagePath = path.join(__dirname, "servergrammar.html");
const app = express();
...
app.post("/api/image", handleAsync(handleImage));
